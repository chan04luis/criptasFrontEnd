...
interface AssignServiciosUserModalProps {
    open: boolean;
    onClose: () => void;
    userId: string | null;
}

const AssignServiciosUserModal: React.FC<AssignServiciosUserModalProps> = ({ open, onClose, userId }) => {
    ...
    const fetchServicios = async () => {
        ...
        try {
            if (userId) {
                const response = await SucursalService.getServiciosByUser(userId);
    ...
    const handleSave = async () => {
        ...
        try {
            if (userId) {
                const response = await SucursalService.setServiciosByUser(userId, servicios);
                if (response.HasError) {
...
export default AssignServiciosUserModal;
